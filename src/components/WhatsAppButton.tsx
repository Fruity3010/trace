...
export function WhatsAppButton() {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" aria-label="Chat with TRACE on WhatsApp"
      className="fixed right-4 bottom-[calc(5rem+env(safe-area-inset-bottom))] z-40 flex h-12 items-center gap-2 rounded-full border border-ink bg-ink px-3.5 text-paper hover:bg-ink-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink lg:right-8 lg:bottom-8 lg:px-5">
